...
% ══════════════════════════════════════════════
\newcommand{\ClientName}{PURELEI GmbH, Glücksteinallee 43-45, 68163 Mannheim}
\newcommand{\ClientFirma}{PURELEI GmbH}
\newcommand{\ClientKurzname}{PURELEI}
\newcommand{\ClientAdresse}{Glücksteinallee 43-45, 68163 Mannheim}
\newcommand{\ClientStadt}{Mannheim}
\newcommand{\ClientBeschreibung}{PURELEI betreibt einen Online-Shop für Schmuck und Accessoires sowie eine zugehörige mobile Applikation.}
\newcommand{\Vertragsbeginn}{22.09.2026}
\newcommand{\Mindestlaufzeit}{6}
\newcommand{\Stundensatz}{103,50}
\newcommand{\Mindeststunden}{80}
\newcommand{\Monatsverguetung}{8.280,00}
\newcommand{\RolloverCap}{40}
\newcommand{\Vertragsstrafe}{5.000,00}
% ══════════════════════════════════════════════
...
Zwischen der \ClientFirma{} (im Folgenden „\ClientKurzname"), \ClientAdresse, und dem Auftragnehmer wird folgender Dienstleistungsvertrag geschlossen. \ClientKurzname{} und der Auftragnehmer werden im Folgenden gemeinsam als „die Vertragsparteien" und einzeln auch als „die Vertragspartei" bezeichnet.
...
2.3.\quad Der Auftragnehmer ist berechtigt, für die Erbringung des Leistungsgegenstandes Dritte als Subunternehmer einzuschalten. Der Auftragnehmer wird dies \ClientKurzname{} allerdings vor Einschaltung eines Dritten als Subunternehmer in Textform anzeigen. \ClientKurzname{} muss dies bestätigen.
...
8.1.\quad Dieser Vertrag wird mit Wirkung ab dem in den Vertragsdaten genannten Vertragsbeginn auf unbestimmte Zeit geschlossen. Es gilt eine Mindestvertragslaufzeit von sechs (\Mindestlaufzeit) Monaten ab Vertragsbeginn.
...
\item Weiterentwicklung und Pflege der mobilen Purelei App (iOS \& Android)
\item Weiterentwicklung und Pflege der Web-Plattform purelei.com
\item Konzeption, Implementierung und Wartung von Features, Schnittstellen und Integrationen
...
\begin{itemize}[itemsep=1pt,topsep=2pt]
\item Plattformen: Android und iOS (aktuelle, gängige OS-Versionen); Web: Chrome, Safari, Firefox, Edge
